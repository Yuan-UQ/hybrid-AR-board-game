...
# ===========================================================================
# Scenario 1: Full first turn 鈥?HumanSide moves archer, skips attack
# ===========================================================================

@scenario("Full turn: move + skip attack")
def scenario_move_skip_attack():
    gs = build_default_state()
    section("Scenario 1 鈥?HumanSide: move archer, skip attack")

    # 鈹€鈹€ Phase START 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    # 鈹€鈹€ Phase MOVEMENT 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    _run_phase(gs, Phase.MOVEMENT, lambda: None)
    archer = gs.pieces["ArcherHuman"]   # (5, 0) after marker-safe start update
    moves = legal_moves(archer, gs)
    step(f"ArcherHuman legal moves: {sorted(moves)}")
    # Archer is at (5,0); (4,0) should be in its legal moves (left one column)
    assert (4, 0) in moves, f"Expected (4,0) in moves, got {moves}"
    apply_move("ArcherHuman", (4, 0), gs)
    assert archer.pos == (4, 0)
    assert gs.board.get_piece_id_at(4, 0) == "ArcherHuman"
    ok("Archer moved (5,0) -> (4,0)")
    advance_phase(gs)

    # 鈹€鈹€ Phase RECOGNITION 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    _run_phase(gs, Phase.RECOGNITION, lambda: None)
    triggers = get_all_triggers(gs)
    if triggers:
        for pid, ep in triggers:
            step(f"Event triggered: {pid} at {ep.pos} 鈫?{ep.event_type.value}")
    ...
    # 鈹€鈹€ Phase ATTACK 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    # 鈹€鈹€ Phase RESOLVE 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    ok(f"Turn ended 鈫?{gs.active_faction.value.upper()}'s turn, round {gs.round_number}")
...
def scenario_attack_kill():
    gs = build_default_state()
    section("Scenario 2 鈥?HumanSide archer kills OrcSide soldier")
    ...
    assert bp.hp == 1, f"Expected 1 HP, got {bp.hp}"   # ATK=2, HP=3 鈫?1
...
# ===========================================================================
# Scenario 3: Kill Leader 鈫?immediate victory
# ===========================================================================

@scenario("Kill Leader 鈫?victory")
def scenario_kill_leader():
    gs = build_default_state()
    section("Scenario 3 鈥?HumanSide lancer kills OrcSide Leader")

    # Weaken OrcSide leader to 1 HP
    bg = gs.pieces["GeneralOrc"]   # (0, 4) 鈥?in OrcSide palace
    bg.hp = 1
    ...
    ok(f"ORCSIDE GENERAL KILLED 鈫?victory_state = {gs.victory_state.value}")
...
def scenario_wizard_aoe():
    gs = build_default_state()
    section("Scenario 4 鈥?HumanSide Wizard cross AOE")
...
def scenario_soldier_bonus():
    gs = build_default_state()
    section("Scenario 5 鈥?Soldier gets +1 ATK from nearby ally")

    # Soldier at (5,4) 鈥?still on HumanSide's side. Place ally adjacent (5,5).
    ...
    _place(gs, "Soldier1Human", 5, 5)   # adjacent 鈫?inside 3脳3 of (5,4)
    step(f"Soldier2Human at (5,4), Soldier1Human at (5,5) 鈥?ally in 3脳3 neighbourhood")

    # Place an enemy directly in front of soldier
    bp = gs.pieces["Soldier3Skeleton"]
    _place(gs, "Soldier3Skeleton", 4, 4)
    step(f"Soldier3Skeleton placed at (4,4) 鈥?directly ahead of soldier")
    ...
    # Soldier ATK=1, ally bonus +1 = 2 total, no palace reduction 鈫?damage=2
...
# ===========================================================================
# Scenario 6: Full round 鈥?HumanSide + OrcSide each complete a turn 鈫?round advances
# ===========================================================================

@scenario("Full round: both players take a turn")
def scenario_full_round():
    gs = build_default_state()
    section("Scenario 6 鈥?Full round (HumanSide + OrcSide), event point spawning rule")
    ...
    def take_minimal_turn(faction_name: str):
        ...
        advance_phase(gs)   # START 鈫?MOVEMENT
        apply_skip_move(gs)
        advance_phase(gs)   # MOVEMENT 鈫?RECOGNITION
        for pid, ep in get_all_triggers(gs):
            apply_event_trigger(pid, ep, gs)
        advance_phase(gs)   # RECOGNITION 鈫?ATTACK
        apply_skip_attack(gs)
        advance_phase(gs)   # ATTACK 鈫?RESOLVE
        end_turn(gs)        # RESOLVE 鈫?next player START
    ...
    # Round 2 starts: even round 鈫?no spawn; event points from round 1 still active
    assert gs.round_number == 2 and gs.active_faction is Faction.HumanSide
    assert not should_spawn_event_point(gs), "Round 2 is even 鈥?no spawn"
    ...
    ok("Round 2 is even 鈥?no new spawn, but event point(s) from round 1 persist")


# ===========================================================================
# Scenario 7: Event point trigger 鈥?Medical heals, Trap kills (via trap)
# ===========================================================================

@scenario("Event point: Medical heal + Trap kill")
def scenario_event_points():
    gs = build_default_state()
    section("Scenario 7 鈥?Event point effects")
    ...
    # TRAP kill: HP at 1, trap reduces to 0 鈫?dead
    gs2 = build_default_state()
    soldier2 = gs2.pieces["Soldier1Human"]
    soldier2.hp = 1
    step("Soldier1Human HP set to 1 鈥?will be killed by trap")
    ...
    ok("TRAP: soldier killed (HP 1 鈫?0), removed from board")
    ...
    ok(f"AMMUNITION stacks: wizard ATK = {wizard.atk} (base {base_atk} + 3脳2 buffs)")
...
def scenario_draw_agreement():
    ...
    ok("Both sides requested draw 鈫?DRAW")
...
def scenario_scanned_deployment():
    section("Scenario 鈥?Deployment scan factory")
    scanned = {
        "ArcherHuman": (5, 0),
        "LancerHuman": (9, 2),
        "WizardHuman": (9, 6),
    ...
    assert gs.pieces["ArcherHuman"].pos == (5, 0)
    assert gs.pieces["Slime Orc"].pos == (0, 2)
    ok("GameState built from scanned deployment dict")


# ===========================================================================
# Scenario 8: Soldier movement 鈥?pre/post river
# ===========================================================================

@scenario("Soldier movement: pre/post river")
def scenario_soldier_movement():
    gs = build_default_state()
    section("Scenario 8 鈥?Soldier pre/post river movement options")

    soldier = gs.pieces["Soldier2Human"]   # (6,4) 鈥?before river (x>4)
    step(f"Soldier at {soldier.pos} 鈥?before river")
    pre_moves = legal_moves(soldier, gs)
    assert pre_moves == [(5, 4)], f"Expected [(5,4)], got {pre_moves}"
    ok(f"Pre-river: only forward 鈫?{pre_moves}")

    # Move soldier to x=4 (crossed river).
    # Soldier2Skeleton sits at (3,4) in the default setup 鈥?move it out of the way
    ...
    step(f"Soldier moved to {soldier.pos} 鈥?after river (x<=4 for HumanSide)")
    ...
    ok(f"Post-river: forward + lateral 鈫?{sorted(post_moves)}")

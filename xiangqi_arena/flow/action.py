...
- Wizard attack requires a direction selection before confirmation.
"""
...
class ActionContext:
    ...
    # Wizard-specific: direction chosen via arrow keys (dx, dy unit vector).
    wizard_direction: Pos | None = None
